          ...
          <div className="min-w-[900px]">
            <div className="grid grid-cols-8 gap-2">
              ...
              <div
                className={cn(
                  "p-3 font-medium text-center rounded-lg",
                  0 === todayIndex ? "bg-primary text-primary-foreground" : "bg-muted/50"
                )}
              >
                Sunday
              </div>
            ...
            <div className="space-y-3">
              {entries
                ...
                .map((entry) => (
                  <div
                    key={entry.id}
                    className="p-4 rounded-lg border bg-primary/5 flex items-center justify-between"
                  >
                    <div>
                      <div className="flex items-center gap-2">
                        <Badge>{entry.section?.course?.code}</Badge>
                        <span className="font-medium">{entry.section?.name}</span>
                      </div>
                    ...
                    <div className="text-right">
                      <p className="font-medium">
                        {entry.time_slot && formatTime(entry.time_slot.start_time)}
                      </p>
                      <p className="text-sm text-muted-foreground">
                        {entry.time_slot && formatTime(entry.time_slot.end_time)}
                      </p>
                    </div>
                  </div>
                ))}
